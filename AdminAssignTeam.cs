...
namespace ES_projects
{
    public partial class AdminAssignTeam : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string connectionstring = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\USERS\\PMLS\\DOWNLOADS\\ES PROJECTS\\ES PROJECTS\\DATABASE1.MDF;Integrated Security=True";
        ...
        private void populate2()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionstring))
            {
                ...
                string selectQuery = "SELECT * FROM Available where Designation=@des "; // Select the columns you need
        ...
        private void del()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionstring))
            {
                ...
                string delQuery1 = "DELETE FROM ADDProjects WHERE projName = @proj";
                SqlCommand command1 = new SqlCommand(delQuery1, connection);
                command1.Parameters.AddWithValue("@proj", proj);
                command1.ExecuteNonQuery(); // Execute the DELETE query.


                string delquery2 = "delete from available where name=@programmer ";
                SqlCommand command2 = new SqlCommand(delquery2, connection);
                command2.Parameters.AddWithValue("@programmer", programmer);
                command2.ExecuteNonQuery(); // execute the delete query.

                string delquery3 = $"delete from available where name=@leader ";
                SqlCommand command3 = new SqlCommand(delquery3, connection);
                command3.Parameters.AddWithValue("@leader", leader);
                command3.ExecuteNonQuery(); // execute the delete query.
            }
        }
    }
}
